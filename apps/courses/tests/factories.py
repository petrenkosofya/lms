...
from core.tests.factories import LocationFactory, AcademicProgramFactory
...
class CourseFactory(factory.django.DjangoModelFactory):
    ...
    completed_at = datetime.date.today() + datetime.timedelta(days=1)
...
class AssignmentFactory(factory.django.DjangoModelFactory):
    ...
    time_zone = factory.LazyAttribute(lambda o: UTC)
    maximum_score = 80
    weight = 1
...
class CourseProgramBindingFactory(factory.django.DjangoModelFactory):
    ...
    start_year_filter = [datetime.date.today().year]
