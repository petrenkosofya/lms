        ...
        $.ajax({
            ...
            if (data.status === 'OK') {
              ...
              editor.getElement('previewerIframe').contentWindow.MathJax.Hub.Queue(function () {
                editor
                  ...
                  .contentWindow.MathJax.Hub.Typeset(epicEditorPreview, function () {
          ...
          .fail(function (data) {
            ...
            if (data.status === 403) {
              ...
              text =
                'Unknown error. Please, save results of your work first, then try to reload page.';
            }
            createNotification(text, 'error')
          });
      } else {
        epicEditorPreview.innerHTML = '<i>No data to preview</i>';
      }
    });
